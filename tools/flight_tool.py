...
#Country name to code : Spain -> ES (Country code for spain)
...
#Airport Matches based on the specified country and also provides the best airport matches
#Checks whether the airport matches with the specified country and also provides the best airport matches based on the specified country
